...
import { Users, Calendar, DollarSign, Settings, LogOut, LayoutGrid, ShieldAlert, GraduationCap, Network } from 'lucide-react';
        ...
        <div className="flex h-screen bg-gray-100 text-gray-900 overflow-hidden font-sans">
            ...
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex z-20">
                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                    ...
                    <Link to="/vinculos" className="flex items-center gap-3 text-gray-700 hover:bg-gray-100 px-3 py-2.5 rounded-sm font-medium transition-colors border-l-4 border-transparent hover:border-[#0F81CA]">
                        <GraduationCap size={18} className="text-[#0F81CA]" />
                        <span>Vínculos Acadêmicos</span>
                    </Link>
                    <Link to="/organizacao" className="flex items-center gap-3 text-gray-700 hover:bg-gray-100 px-3 py-2.5 rounded-sm font-medium transition-colors border-l-4 border-transparent hover:border-[#0F81CA]">
                        <Network size={18} className="text-[#0F81CA]" />
